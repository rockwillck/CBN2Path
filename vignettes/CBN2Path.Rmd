...
The directed acyclic graph representation of the input poset can be visualized using the **`visualizeCBNModel`** function as follows:
...
You can see that the maximum-likelihood poset according to the CT-CBN model in this example is the empty poset.
...
You can see that in this example, the maximum-likelihood poset based on H-CBN contains an edge in contrast to the CT-CBN model, which outputs an empty poset.
