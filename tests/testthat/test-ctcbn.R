test_that("CT-CBN works", {
  ...
  expect_equal(ctcbnSingle(bc, epsilon = 0.7)$summary[[14]], 1.350237879)
  ...
  expect_equal(ctcbnSingle(hiv)$lambda[3,1], 0.189185)
  expect_equal(ctcbnSingle(hiv)$summary[[4]], -213.0950000)
